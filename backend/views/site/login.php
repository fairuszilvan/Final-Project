...
<div class="login-box">
    ...
    <!-- /.login-logo -->
    <div class="login-box-body" style="background-color: rgba(255, 255, 255, 0.7)">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <?= Html::submitButton('Login', ['class' => 'btn btn-success btn-block btn-sm', 'style' => 'border-radius: 40px', 'name' => 'login-button']) ?>
            </div>
