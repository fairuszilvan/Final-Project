...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Jul 2022 pada 15.23
...
-- Database: `mgtasset`
--
CREATE DATABASE IF NOT EXISTS `mgtasset` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mgtasset`;
...
('root', '[{\"db\":\"mgtasset\",\"table\":\"asset_master\"},{\"db\":\"mgtasset\",\"table\":\"asset_code\"},{\"db\":\"mgtasset\",\"table\":\"asset_item\"},{\"db\":\"mgtasset\",\"table\":\"asset_item_maintenance\"}]');
...
('root', '2022-07-03 07:04:04', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
